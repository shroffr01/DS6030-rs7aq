...
lgbm_tuning = list(objective = "poisson",num_class = 1,nrounds = 100,min_gain_to_split = 1,learning_rate = 0.1,max_depth = 2,bagging_freq = 1,bagging_fraction = 0.8, bagging_seed = 123)
...
for (i in nrounds){
  ...
  for (j in tree_depth){
    ...
    a <-  data.frame(nrounds=i, tree_deth=j, rmse=last_rmse_value)
...
# This indicates that 400 trees and a depth of 10 are the optimal parameters. 
...
lgbm_tuning = list(objective = "poisson",num_class = 1,nrounds = 400,min_gain_to_split = 1,learning_rate = 0.1,max_depth = 10,bagging_freq = 1,bagging_fraction = 0.8, bagging_seed = 123)
