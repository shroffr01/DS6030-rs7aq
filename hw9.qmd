...
boxplot(avg_loss_df, 
        main = "Permutation Feature Importance - Loss Distribution",
        xlab = "Features",
        ylab = "Log Loss",
...
Approach 2: Allows us to see direct impact of test data, not as computationally expensive

Approach 3: Prevents overfit and provides more data
:::
...
```{r}
rand_numbers_train <- round(runif(n=50, min=1, max=1003), 0)
rand_numbers_test <- round(runif(n=15, min=1, max=297), 0)
